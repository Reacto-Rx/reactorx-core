...
object ReactorTranslatorHelper {
    ...
    fun <T : IReactorTranslator> findTranslatorFragment(fragmentManager: FragmentManager): ReactorTranslatorFragment<T>? {
        return fragmentManager.findFragmentByTag(ReactorTranslatorFragment.TAG)
                as ReactorTranslatorFragment<T>?
    }

    @SuppressLint("CommitTransaction")
    fun <T : IReactorTranslator> getTranslatorFromFragment(fragmentManager: FragmentManager, translatorFactory: TranslatorFactory<T>): T {
