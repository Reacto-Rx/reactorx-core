...
import org.reactorx2.state.model.impl.Init
import org.reactorx2.state.model.impl.Void
...
class StateStore<T> private constructor(
        ...
        private val extraTransformerObservablesObtainer: ((Observable<Action>) -> Array<Observable<out org.reactorx2.presenter.model.Action>>)? = null
) {
    ...
    companion object {
        ...
        /**
         * [Action] to cause no mutation on the [org.reactorx2.state.StateStore] state
         * (not guaranteed)
         */
    ...
    class Builder<T>(
        ...
        private var extraTransformerObservablesObtainer: ((Observable<Action>) -> Array<Observable<out org.reactorx2.presenter.model.Action>>)? = null
        ...
        fun extraTransformerObservablesObtainer(
                action: ((Observable<Action>) -> Array<Observable<out org.reactorx2.presenter.model.Action>>)?
        ): Builder<T> {
