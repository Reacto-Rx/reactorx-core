package org.reactorx2.presenter
...
abstract class Presenter<M> : ViewModel() {
    ...
    ): Array<Observable<out org.reactorx2.presenter.model.Action>> {
        return emptyArray()
    }
    ...
    open protected fun reduceState(previousState: M, action: Action): M {
        return if (action is org.reactorx2.presenter.model.Action) {
    ...
    open protected fun stateReducer(previousState: M, action: org.reactorx2.presenter.model.Action): M {
